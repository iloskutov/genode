...
LX_MUTEX_INIT_DECLARE(table_lock);
#define table_lock         LX_MUTEX(table_lock)
...
int module_usb_serial_init(void);
int module_usb_serial_module_init_ftdi_so(void);
int module_usb_serial_module_init_option(void);
int module_usb_serial_module_init_pl2303(void);
...
#define module_name(mod)	"usb_serial"
...
#define __ATTR_WO(name) __ATTR_NULL
